...
class DerData:
	def __init__(self, data: typing.List[int], construct: bool, _internal = 0):
		if(_internal == 0):
	...
	def read_octet_string(self) -> typing.List[int]:
		return self._instance.ReadOctetString()
	def read_bit_string(self) -> typing.List[int]:
		return self._instance.ReadBitString()
	def read_object(self) -> typing.List[int]:
	...
	def write(self, data: typing.List[int]) -> None:
		self._instance.Write(data)
	def write_bitstring(self, data: typing.List[int]) -> None:
	...
	def write_object_identifier(self, bytes: typing.List[int]) -> None:
	...
	def read_bytes(self, length: int) -> typing.List[int]:
