...
class SshClientBase(URServiceBase):
	...
	def create_shell(self, input: typing.Any, output: typing.Any, extendedOutput: typing.Any, terminalName: str, columns: int, rows: int, width: int, height: int, terminalModes: typing.Any, bufferSize: int) -> Shell:
		return Shell(self._instance.CreateShell(input, output, extendedOutput, terminalName, columns, rows, width, height, terminalModes, bufferSize))
	def create_shell(self, input: typing.Any, output: typing.Any, extendedOutput: typing.Any, terminalName: str, columns: int, rows: int, width: int, height: int, terminalModes: typing.Any) -> Shell:
		return Shell(self._instance.CreateShell(input, output, extendedOutput, terminalName, columns, rows, width, height, terminalModes))
	def create_shell(self, input: typing.Any, output: typing.Any, extendedOutput: typing.Any) -> Shell:
		return Shell(self._instance.CreateShell(input, output, extendedOutput))
	...
	def create_shell(self, encoding: typing.Any, input: str, output: typing.Any, extendedOutput: typing.Any, terminalName: str, columns: int, rows: int, width: int, height: int, terminalModes: typing.Any) -> Shell:
		return Shell(self._instance.CreateShell(encoding, input, output, extendedOutput, terminalName, columns, rows, width, height, terminalModes))
	def create_shell(self, encoding: typing.Any, input: str, output: typing.Any, extendedOutput: typing.Any) -> Shell:
		return Shell(self._instance.CreateShell(encoding, input, output, extendedOutput))
