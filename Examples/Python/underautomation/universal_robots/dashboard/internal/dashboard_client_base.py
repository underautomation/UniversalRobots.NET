...
class DashboardClientBase(URServiceBase):
	...
	def get_variable(self, name: str) -> CommandResponse1:
		return CommandResponse1(None, self._instance.GetVariable(name))
	def shutdown(self) -> CommandResponse:
		return CommandResponse(self._instance.Shutdown())
	def is_program_running(self) -> CommandResponse1:
		return CommandResponse1(None, self._instance.IsProgramRunning())
	def get_robot_mode(self) -> CommandResponse1:
		return CommandResponse1(None, self._instance.GetRobotMode())
	def get_loaded_program(self) -> CommandResponse1:
		return CommandResponse1(None, self._instance.GetLoadedProgram())
	...
	def is_program_saved(self) -> CommandResponse1:
		return CommandResponse1(None, self._instance.IsProgramSaved())
	def get_program_state(self) -> CommandResponse1:
		return CommandResponse1(None, self._instance.GetProgramState())
	def get_polyscope_version(self) -> CommandResponse1:
		return CommandResponse1(None, self._instance.GetPolyscopeVersion())
	...
	def get_operational_mode(self) -> CommandResponse1:
		return CommandResponse1(None, self._instance.GetOperationalMode())
	def is_in_remote_control(self) -> CommandResponse1:
		return CommandResponse1(None, self._instance.IsInRemoteControl())
	...
	def get_safety_status(self) -> CommandResponse1:
		return CommandResponse1(None, self._instance.GetSafetyStatus())
	def get_serial_number(self) -> CommandResponse:
		return CommandResponse(self._instance.GetSerialNumber())
	def get_robot_model(self) -> CommandResponse1:
		return CommandResponse1(None, self._instance.GetRobotModel())
	@property
	def ip(self) -> str:
