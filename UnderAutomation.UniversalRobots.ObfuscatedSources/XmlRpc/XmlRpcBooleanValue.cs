...
namespace XmlRpc {
	...
	public class XmlRpcBooleanValue : XmlRpcValue {
		...
		/// <returns><code>true</code> if the specified object is an <xref href="UnderAutomation.UniversalRobots.XmlRpc.XmlRpcBooleanValue" data-throw-if-not-resolved="false"></xref> with the same value; otherwise, <code>false</code>.</returns>
