...
from UnderAutomation.UniversalRobots.SocketCommunication import SocketClientDisconnectionEventArgs as socket_client_disconnection_event_args

class SocketClientDisconnectionEventArgs:
