import typing
from underautomation.universal_robots.ur_archive import URArchive
import clr
import os
clr.AddReference(os.path.realpath(os.path.join(os.path.dirname(__file__), "..", "..", 'lib', 'UnderAutomation.UniversalRobots.dll')))
from UnderAutomation.UniversalRobots import URInstallation as ur_installation
...
class URInstallation(URArchive):
	...
	def load(urpFile: str) -> 'URInstallation':
		return ur_installation.Load(urpFile)
	@property
