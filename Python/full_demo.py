...
parameters.rtde.output_setup.add(RtdeOutputData.ActualTcpSpeed)
parameters.rtde.output_setup.add(RtdeOutputData.ActualTcpForce)
parameters.rtde.output_setup.add(RtdeOutputData.ActualCurrent)
parameters.rtde.output_setup.add(RtdeOutputData.InputIntRegisters, 0)
