    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                System.Console.WriteLine(" _   _       _                          _  ______      _           _        ");
                System.Console.WriteLine("| | | |     (_)                        | | | ___ \\    | |         | |       ");
                System.Console.WriteLine("| | | |_ __  ___   _____ _ __ ___  __ _| | | |_/ /___ | |__   ___ | |_ ___  ");
                System.Console.WriteLine("| | | | '_ \\| \\ \\ / / _ \\ '__/ __|/ _` | | |    // _ \\| '_ \\ / _ \\| __/ __| ");
                System.Console.WriteLine("| |_| | | | | |\\ V /  __/ |  \\__ \\ (_| | | | |\\ \\ (_) | |_) | (_) | |_\\__ \\ ");
                System.Console.WriteLine(" \\___/|_| |_|_| \\_/ \\___|_|  |___/\\__,_|_| \\_| \\_\\___/|_.__/ \\___/ \\__|___/ ");
                System.Console.WriteLine(" _____                       _        _____                          _      ");
                System.Console.WriteLine("/  __ \\                     | |      |  ___|                        | |     ");
                System.Console.WriteLine("| /  \\/ ___  _ __  ___  ___ | | ___  | |____  ____ _ _ __ ___  _ __ | | ___ ");
                System.Console.WriteLine("| |    / _ \\| '_ \\/ __|/ _ \\| |/ _ \\ |  __\\ \\/ / _` | '_ ` _ \\| '_ \\| |/ _ \\");
                System.Console.WriteLine("| \\__/\\ (_) | | | \\__ \\ (_) | |  __/ | |___>  < (_| | | | | | | |_) | |  __/");
                System.Console.WriteLine(" \\____/\\___/|_| |_|___/\\___/|_|\\___| \\____/_/\\_\\__,_|_| |_| |_| .__/|_|\\___|");
                System.Console.WriteLine("                                                              | |           ");
                System.Console.WriteLine("                                                              |_|           ");
                System.Console.WriteLine();

                System.Console.WriteLine(UR.LicenseInfo.ToString());
                System.Console.WriteLine();

                System.Console.Write("Please enter robot IP or hostname : ");
        ...
        private static void CartesianInfoReceived(object sender, CartesianInfoPackageEventArgs e)
        {
            ...
            System.Console.WriteLine($"Y = {e.Y.ToString("0.00")}mm");
            System.Console.WriteLine($"Z = {e.Z.ToString("0.00")}mm");
            System.Console.WriteLine($"RX = {e.Rx.ToString("0.00")}°");
            System.Console.WriteLine($"RY = {e.Ry.ToString("0.00")}°");
            System.Console.WriteLine($"RZ = {e.Rz.ToString("0.00")}°");
        ...
        {
            System.Console.WriteLine("Robot IP : " + request.EndPoint.Address);
            // Prints :
            ...
            switch (request.MethodName)
            {
                case "get_answer":
                    ...
                    {
                        System.Console.WriteLine(argument.ToString()); // Prints argument value : "Hello", "true", "false", "12", ...
                    }
